/** Hash table implementation using open addressing with double hashing probing. */
public class HashtableOpenDoubleHashing<K, V> implements KWHashMap<K, V>
{
    ...
    // Constructor
    public HashtableOpenDoubleHashing() {
     ...
     * search chain using double hashing probing
     *
    ...
    {
        // Calculate the starting index with first hashing
        int index = key.hashCode() % table.length;
        if (index < 0)
            index += table.length; // Make it positive.

        // get index2 with second hashing
        int index2= second_hash(key);

        // Change the index until an empty slot is reached
        // or the key is found.
        // Collision case
        int i=1;
     ...
     * using any prime number; prime-(key % prime)
     * for this function chosen prime number is 7
     * @param key key value of entry
     * @return the second hashing number
     */
